...
import { PaintBucket, Clock, CheckCircle, Shield, Award, Users, Brush, Palette, Home as HomeIcon, FileEdit, Droplets } from 'lucide-react';
...
const Home: React.FC = () => {
  return (
    <main className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-primary-900 to-primary-500 text-white py-20 md:py-32 paint-texture">
      ...
      {/* Problem Section */}
      <section className="py-20 bg-gray-50 brush-stroke">
        <Container>
      ...
      {/* About Section */}
      <section className="py-20 bg-white paint-drip">
        <Container>
          <AnimatedElement animation="fade-up">
            <SectionTitle
      ...
      {/* Benefits Section */}
      <section className="py-20 bg-gray-50 paint-texture">
        <Container>
          <AnimatedElement animation="fade-up">
            <SectionTitle
      ...
      {/* Services Section */}
      <section className="py-20 bg-white brush-stroke">
        <Container>
          <AnimatedElement animation="fade-up">
            <SectionTitle
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
                <HomeIcon className="w-10 h-10 text-primary-600 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-4">Exterior Painting</h3>
                <p className="text-gray-600">Our exterior painting service will protect your property from the elements while adding curb appeal. We use high-quality, weather-resistant paints to ensure your building looks fresh and beautiful for years to come.</p>
              </div>
              
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
                <Brush className="w-10 h-10 text-primary-600 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-4">Interior Painting</h3>
                <p className="text-gray-600">Transform your indoor spaces with our expert interior painting service. We use premium paints and take care of every detail to give your walls a smooth and even finish.</p>
              </div>
              
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
                <Palette className="w-10 h-10 text-primary-600 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-4">Texture Painting</h3>
                <p className="text-gray-600">Looking to add a unique touch to your walls? Our texture painting service offers a wide range of finishes and textures to give your space character and charm.</p>
              </div>
              
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
                <FileEdit className="w-10 h-10 text-primary-600 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-4">Wood Painting</h3>
                <p className="text-gray-600">Whether it's wooden doors, windows, or furniture, our wood painting service ensures your wood surfaces get the care they need.</p>
              </div>
              
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
                <Shield className="w-10 h-10 text-primary-600 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-4">Metal Painting</h3>
                <p className="text-gray-600">Our metal painting service is designed to protect and beautify your metal surfaces. We apply high-quality paint that prevents rust and adds a polished look to gates, grills, and other metal features.</p>
              </div>
              
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
                <Droplets className="w-10 h-10 text-primary-600 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-4">Waterproofing Painting</h3>
                <p className="text-gray-600">Protect your property from water damage with our waterproofing painting service. We use specialized products to create a protective barrier on your walls, preventing leaks and dampness.</p>
              </div>
            </div>
          </AnimatedElement>
        </Container>
      ...
      {/* Process Section */}
      <section className="py-20 bg-gray-50 paint-drip">
        <Container>
          <AnimatedElement animation="fade-up">
            <SectionTitle
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-lg relative">
                ...
                <p className="text-gray-600 mb-4">Contact us to schedule a consultation with your trusted Chennai painter, where we'll discuss your project needs and goals.</p>
                <p className="text-primary-600 font-medium">Benefit: Get clarity on your vision and how our painting contractors in Chennai can bring it to life.</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg relative">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-4">Get a Personalized Quote</h3>
                <p className="text-gray-600 mb-4">We provide a detailed, transparent quote based on your requirements.</p>
                <p className="text-primary-600 font-medium">Benefit: Know exactly what to expect, with no surprises.</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg relative">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-4">Enjoy the Transformation</h3>
                <p className="text-gray-600 mb-4">Our expert painters handle every detail from start to finish.</p>
                <p className="text-primary-600 font-medium">Benefit: Sit back and enjoy a beautifully painted space without stress.</p>
              </div>
            </div>
          </AnimatedElement>
        </Container>
      ...
      {/* Features Section */}
      <section className="py-20 bg-white paint-texture">
        <Container>
          <AnimatedElement animation="fade-up">
            <SectionTitle
